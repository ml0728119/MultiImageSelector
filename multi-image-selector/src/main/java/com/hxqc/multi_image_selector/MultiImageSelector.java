...
public class MultiImageSelector {
     ...
     * 照片是否保存到相册
     */
    public MultiImageSelector save2Gallery(boolean save) {
        multiImageControl.setSave2Gallery(save);
        return this;
    }
    ...
    static public class MultiImageControl {
        ...
        boolean save2Gallery = false;//照片保存到相册，默认不保存

        boolean isSave2Gallery() {
            return save2Gallery;
        }

        MultiImageControl setSave2Gallery(boolean save2Gallery) {
            this.save2Gallery = save2Gallery;
            return this;
        }
